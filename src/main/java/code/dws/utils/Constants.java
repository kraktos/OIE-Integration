...
public class Constants {
	...
	public static final String PSUBCONF_FILE = DIRECTORY
			+ "psubConf.nell.dbpedia.db";
	 ...
	 */
	public static final String INPUT_CSV_FILE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/goldBL_"
			+ ExperimentAutomation.PREDICATE + ".tsv";

	/**
	 * output owl file of the NELL input triples
	 */
	public static final String OUTPUT_OWL_FILE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/data.owl";

	/**
	 * gold standard evidence file, post-fixed
	 */
	public static final String GOLD_MLN_EVIDENCE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/goldEvidencePostFixed.db";

	/**
	 * gold standard evidence file, post-fixed
	 */
	public static final String GOLD_MLN_EVIDENCE_ALL = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/goldEvidencePostFixedAll.db";
	 ...
	 */
	public static final String APRIORI_PROB_FILE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/sameAsLinksPrior.tsv";
	 ...
	 */
	public static final String NELL_CONFIDENCE_FILE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/NELLTripleConfidences."
			+ ExperimentAutomation.PREDICATE + ".csv";

	/**
	 * location of different from MLN evidences
	 */
	public static final String DIFFERENTFROM_DBPEDIA_EVIDENCE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/differentFrom.dbpedia";

	/**
	 * isOfType MLN evidence location
	 */
	public static final String IS_OF_TYPE_DBPEDIA_EVIDENCE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/isOfType.dbpedia";
	 ...
	 */
	public static final String BL_DUMP = "resource/output/blSample."
			+ ExperimentAutomation.PREDICATE + ".tsv";

	/**
	 * annotated gold standard dump of the predicated. should contain 100 rows
	 * always
	 */
	public static String FULL_GS_DUMP = "resource/input/ALL."
			+ ExperimentAutomation.PREDICATE + ".tsv";

	/**
	 * gold standard evidence file, post-fixed
	 */
	public static final String SOURCE_TYPE_EVIDENCE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/sourceType.db";

	/**
	 * dom range evidence writer
	 */
	public static final String DOM_RAN_EVIDENCE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/domRanEvid.db";

	public static final Double DOMRAN_CONFIDENCE_THRESHOLD = 0.500;

	/**
	 * value used to scale up and down the node values while working with the
	 * DBPedia tree
	 */
	...
	public static final String DOMAIN_RANGE_PREFERENCE_FILE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/domRanAlpha"
			+ TREE_PROPAGATION_FACTOR + "." + String.valueOf(USE_LOGIT_FUNC)
			+ ".out";

	public static final String DOMAIN_RANGE_BS_PREFERENCE_FILE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/domRanAlphaBS"
			+ TREE_PROPAGATION_FACTOR + "." + String.valueOf(USE_LOGIT_FUNC)
			+ ".out";

	public static final String DOMAIN_RANGE_EVIDENCE_FILE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/domRanEvidence.db";

	public static final String DOMAIN_RANGE_BS_EVIDENCE_FILE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/domRanEvidenceBS.db";
	 ...
	 */
	public static final String KDE_EVIDENCE_ALL = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/KDEEvidenceAll.db";

	/**
	 * gold standard evidence file, post-fixed
	 */
	public static final String ALL_MLN_EVIDENCE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/AllEvidence.db";

	/**
	 * gold standard evidence file, post-fixed
	 */
	public static final String ALL_MLN_EVIDENCE_T1 = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/AllEvidence_T1.db";

	public static final String BASIC_REASON_OUT_FILE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/out.db";

	/**
	 * gold standard evidence file, post-fixed
	 */
	public static final String REASONER_OUTPUT_MLN_EVIDENCE = sample_dumps
			+ ExperimentAutomation.PREDICATE + "/outAll_1.db";

	/**
	 * flag to denote if the type information of DBPedia instances should be
	 * reloaded in Database or old data should be used.
	 */
	...
	public static final boolean INCLUDE_YAGO_TYPES = ExperimentAutomation.INCLUDE_YAGO_TYPES;
