...
public class PropertyStatistics {
	...
	public static void loadPropStatsInMem(String filePath) {
		...
		log.info("TOTAL NON-MAPABLE TRIPLES = " + blankMapCntr + " i.e "
				+ (double) blankMapCntr / directPropsFile.size());

		log.info("TOTAL MAPPED TRIPLES = " + nonBlankCntr + " i.e "
				+ (double) nonBlankCntr / directPropsFile.size());

		log.debug("Distribution for buildinglocatedincity "
				+ MAP_OIE_IE_PROP_COUNTS.get("buildinglocatedincity"));
