...
public class BootStrapMethod {
	...
	public static void main(String[] args) throws IOException {
		...
		nodeScorer.rankTypes(GenericConverter.SUB_SET_TYPES,
				SET_FULL_SUB_TYPES, domRangPrefWriter, domRangEvidenceWriter,
				Constants.DOMAIN);
		...
		nodeScorer.rankTypes(GenericConverter.OBJ_SET_TYPES,
				SET_FULL_OBJ_TYPES, domRangPrefWriter, domRangEvidenceWriter,
				Constants.RANGE);
	...
	public static void createSameAsHypotheses(String outputEvidenceFilePath)
		...
		while ((line = reader.readLine()) != null) {
			...
			while (m.find()) {
				...
				SAME_AS_LIST.add(new Pair<String, String>(
						m.group(1).split(",")[0], m.group(1).split(",")[1]));
			}
		}
	}
